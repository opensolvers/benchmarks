...
const MLAS_QNBIT_GEMM_DISPATCH&
GetMlasQNBitGemmDispatchRvv();

const MLAS_QNBIT_GEMM_DISPATCH&
GetMlasQNBitGemmDispatchScalar();
...
#if defined(MLAS_TARGET_RISCV64) && defined(MLAS_USE_RVV_ZVFH)
extern const MLAS_HGEMM_DISPATCH MlasHGemmDispatchRvv;
extern const MLAS_SOFTMAX_DISPATCH MlasSoftmaxDispatchRvv;
extern const MLAS_ELTWISE_DISPATCH MlasEltwiseDispatchRvv;
#endif
