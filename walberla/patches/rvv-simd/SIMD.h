...
#define WALBERLA_SIMD_RVV_AVAILABLE 1
#endif
...
#if defined( WALBERLA_SIMD_RVV_AVAILABLE ) && !defined( WALBERLA_USE_SIMD )
#include "RVV.h"
#define WALBERLA_USE_RVV  1
#define WALBERLA_USE_SIMD 1
#endif
...
#ifdef WALBERLA_USE_RVV
   using namespace rvv;
   template<> struct is_vector4_type<rvv::double4_t> {  static const bool value = true; };
#endif
